# MoonGlass 商用授权与参考价格 / Commercial Licensing and Reference Pricing

> 本页用于说明可选商用方案，不构成自动授予许可或不可撤销报价。具体授权主体、使用范围、席位、期限、支持服务、税费与责任边界，以双方签署的书面合同为准。中英文不一致时，以中文为准。

## 1. 社区许可

MoonGlass 采用 **PolyForm Noncommercial License 1.0.0** 公开源代码。个人学习、实验、非商业教育和符合许可证定义的非商业组织用途可免费使用、修改和分发。

任何预期或实际服务于商业产品、收费服务、企业内部商业研发、客户交付、流片或量产的用途，均应在使用前取得 MoonGlass 的书面商用授权。
...
用户输入的需求、规格、RTL、验证环境、脚本、报告以及使用 MoonGlass 生成的设计成果，其权利归用户或其合法权利人所有。MoonGlass 不因软件运行而主张这些内容的所有权。

若输出中包含可识别的 MoonGlass 第一方代码、模板或资源，这些嵌入部分仍受 MoonGlass 许可证或商用合同约束。用户应自行确认第三方模型、EDA 工具、IP、PDK 与依赖组件的许可条件。

## 4. 联系方式

- 商务授权与定制开发：`moonglassagent@126.com`
- 邮件主题建议：`MoonGlass 商用授权咨询 - 公司/团队名称`
...
Commercial contact: `moonglassagent@126.com`. If the Chinese and English texts conflict, the Chinese text prevails.
