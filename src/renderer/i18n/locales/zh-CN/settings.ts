...
export const settings = {
  ...
  eda: {
    ...
    confirmVerible: '将从官方 GitHub Release 下载 Verible Windows 版并解压到 MoonGlass 工具链目录，是否继续？',
    confirmInstallMissing: '将自动检测缺失的工具，并依次下载安装可自动安装的工具包（OSS CAD Suite / Verible / Cocotb），是否继续？',
    installingCocotb: '正在通过 pip 安装 Cocotb…',
    installingBundle: '正在下载并解压工具包，请保持网络连接…',
    installingVerible: '正在下载并解压 Verible…',
    installing: '安装中…',
    installCocotb: '安装 Cocotb',
    installBundle: '安装工具包',
    installVerible: '安装 Verible',
    installMissing: '一键安装缺失工具',
    installingMissing: '正在检测缺失的工具并依次安装…',
    envReady: '环境已就绪',
    installMissingResult: '一键安装结果',
    installMissingInstalled: '已安装：{items}',
    installMissingFailed: '安装失败：{items}',
    installMissingManual: '以下工具需手动安装（点击打开安装指引）：',
    physicalNoInstall: '暂不支持 Windows 一键安装',
    installGuide: '安装指南',
