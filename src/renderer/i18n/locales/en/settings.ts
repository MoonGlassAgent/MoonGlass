...
export const settings: SettingsMessages = {
  ...
  eda: {
    ...
    confirmVerible: 'Download the Windows build of Verible from the official GitHub Release and extract it into the MoonGlass toolchain directory. Continue?',
    confirmInstallMissing: 'Detect missing tools and download/install the automatically installable bundles in order (OSS CAD Suite / Verible / Cocotb). Continue?',
    ...
    installingVerible: 'Downloading and extracting Verible…',
    installing: 'Installing…',
    installCocotb: 'Install Cocotb',
    installBundle: 'Install Bundle',
    installVerible: 'Install Verible',
    installMissing: 'Install Missing Tools',
    installingMissing: 'Detecting missing tools and installing them in order…',
    envReady: 'Environment Ready',
    installMissingResult: 'One-Click Install Result',
    installMissingInstalled: 'Installed: {items}',
    installMissingFailed: 'Failed: {items}',
    installMissingManual: 'The following tools require manual installation (click to open the install guide):',
    physicalNoInstall: 'One-click install not supported on Windows',
